...
internal class JCEmoticonBackgroundView: UIView {
    ...
    private func _init() {
        ...
        addConstraint(_JCEmoticonLayoutConstraintMake(_leftView, .left, .equal, self, .left, priority: UILayoutPriority(751)))
        ...
        addConstraint(_JCEmoticonLayoutConstraintMake(_rightView, .right, .equal, self, .right, priority: UILayoutPriority(751)))
